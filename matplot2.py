...
class MyWidget(QWidget):
    ...
    def __init__(self):
        ...
        grid = QHBoxLayout()
        self.groupBox = QGroupBox('matplot ver.2.1.1')
        ...
        self.lccombo.addItems(['defalt','Blue','Green','Red','Cyan','Magenta','Yellow','Black','White'])
        self.ltcombo = QComboBox()
        self.ltcombo.addItems(['-','--',':','o'])
    ...
    def open_FileDialog(self):
        filerecord = os.path.expanduser('~/MAT_PLOT') + '/open_file.txt'
    ...
    def log_FileDialog(self):
        filename = QFileDialog.getOpenFileName(self, 'log file', os.path.expanduser('~/MAT_PLOT') + '/Log')
        filename = str(filename[0])
        self.ledit.setText(filename)
